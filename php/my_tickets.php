...
$tickets = fetch_user_tickets(intval($_SESSION['userId']), $_SESSION['ticket_query_status'], intval($_SESSION['ticket_query_priority']), intval($_SESSION['ticket_query_depertment_id']));
show_common();
?>
<div class="content">
